...
> Historical/reference only. Active redesign source of truth: [`../ui-redesign-plan-vi.md`](../ui-redesign-plan-vi.md), [`../motion-system-plan-vi.md`](../motion-system-plan-vi.md), [`../design-tokens-vi.md`](../design-tokens-vi.md), [`../frontend-architecture.md`](../frontend-architecture.md), and [`../../PROJECT_AI_NOTES.md`](../../PROJECT_AI_NOTES.md).
