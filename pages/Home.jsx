  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        ...
        <section className="w-full max-w-7xl mx-auto px-4 md:px-10 py-12 md:py-20">
          <div className="flex flex-col-reverse gap-8 md:gap-12 md:flex-row items-center">
            <div className="flex flex-col gap-6 flex-1 text-center md:text-left items-center md:items-start">
              ...
              <h2 className="text-text-secondary text-lg md:text-xl font-medium max-w-xl">
                Low-maintenance greenery delivered to your desk. Managed by AI, enjoyed by you.
              </h2>
              <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                <Link to="/plants" className="flex w-full sm:w-auto min-w-[160px] h-12 items-center justify-center rounded-lg bg-primary px-6 text-text-main text-base font-bold shadow-lg hover:shadow-primary/25 transition-all">
                  View Plants
                </Link>
                <button className="flex w-full sm:w-auto min-w-[160px] h-12 items-center justify-center rounded-lg border border-gray-200 bg-white px-6 text-text-main text-base font-bold hover:bg-gray-50 transition-colors">
                  How it Works
                </button>
              </div>
            </div>
            <div className="w-full md:w-1/2 lg:w-3/5">
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl">
                ...
                />
                <div className="absolute bottom-6 left-6 right-6 md:left-auto md:right-6 md:w-64 bg-white/90 backdrop-blur rounded-xl p-4 shadow-xl border border-white/20">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="size-8 rounded-full bg-primary/20 flex items-center justify-center text-primary">
                      <span className="material-symbols-outlined text-lg">water_drop</span>
                    </div>
                    <div>
                      <p className="text-xs font-bold text-text-main">Thirsty!</p>
        ...
        <section className="bg-white py-16 md:py-24 border-y border-[#f0f4f2]">
          <div className="max-w-7xl mx-auto px-4 md:px-10">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-black mb-4">Why DeskBoost?</h2>
              <p className="text-text-secondary text-lg max-w-xl mx-auto">Designed for the modern professional who loves nature but lacks the time.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={i} className="group p-6 bg-white border border-[#dbe6df] rounded-xl hover:shadow-lg transition-all hover:border-primary/50">
                  ...
                  <p className="text-text-secondary text-base leading-relaxed">{f.text}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-4 md:px-10 py-16 md:py-24">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-2xl md:text-3xl font-bold">Desk Favorites</h2>
          ...
          <div className="flex overflow-x-auto no-scrollbar gap-6 pb-4">
            {PLANTS.map((p) => (
              <Link to={`/plants/${p.id}`} key={p.id} className="flex flex-col min-w-[280px] bg-white border border-gray-100 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow group">
                ...
                <div className="p-5 flex flex-col gap-4">
                  ...
                  <button className="w-full h-10 rounded-lg bg-[#f0f4f2] text-text-main text-sm font-bold hover:bg-primary transition-colors">
                    Add to Cart
                  </button>
                </div>
              </Link>
      ...
      <footer className="w-full bg-white border-t border-[#f0f4f2] py-12 text-center md:text-left">
        <div className="max-w-7xl mx-auto px-4 md:px-10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <p className="text-xs text-gray-400">© 2024 DeskBoost Inc. All plants reserved.</p>
        </div>
      </footer>
      <ChatbotWidget />
    </div>
