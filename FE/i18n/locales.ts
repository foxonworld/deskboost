...
const vi = {
  ...
  "reminders.error.load":
    "Không tải được nhắc nhở. Đang dùng dữ liệu dự phòng nếu có.",
  ...
  "reminders.settingsDesc":
    "Cấu hình cây, loại, tần suất, giờ và trạng thái bật.",
...
const en: Partial<Record<TranslationKey, TranslationValue>> = {
  ...
  "reminders.error.load":
    "Could not load reminders. Using fallback data if available.",
  "reminders.notice.opening":
  ...
  "reminders.settingsDesc":
    "Configure plant, type, frequency, time, enabled state.",
  ...
  "home.stats.feedback.val": "200+",
  "home.stats.feedback.label": "Verified Feedbacks",
