...
const trustSignalKeys = [
  { valueKey: 'home.trust.contact.value', labelKey: 'home.trust.contact.label' },
  { valueKey: 'home.trust.ai.value', labelKey: 'home.trust.ai.label' },
  { valueKey: 'home.trust.manual.value', labelKey: 'home.trust.manual.label' },
];
              ...
              <div data-motion="home-hero" className="grid w-full gap-3 sm:grid-cols-3">
                {trustSignalKeys.map((item) => (
                  <div key={item.valueKey} className="rounded-2xl border border-[#E4EEE6] bg-white/70 p-4 shadow-sm backdrop-blur dark:border-[#2A4532] dark:bg-white/5">
                    <p className="text-sm font-extrabold text-text-main dark:text-white">{t(item.valueKey)}</p>
        ...
        <section data-motion="home-section" className="mx-auto w-full max-w-7xl px-4 py-14 md:px-10 md:py-20">
          <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                { icon: 'light_mode', titleKey: 'home.feature.environment.title', textKey: 'home.feature.environment.text' },
                { icon: 'health_and_safety', titleKey: 'home.feature.state.title', textKey: 'home.feature.state.text' },
                { icon: 'forum', titleKey: 'home.feature.contact.title', textKey: 'home.feature.contact.text' },
                { icon: 'verified', titleKey: 'home.feature.feedback.title', textKey: 'home.feature.feedback.text' },
              ].map((item) => (
