        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WateringCycleDays = table.Column<int>(type: "integer", nullable: false),
                    LastCondition = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    Status = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AiDialogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AiDialogs_Plants_PlantId",
                        column: x => x.PlantId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiseasesJson = table.Column<string>(type: "text", nullable: false),
                    CausesJson = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    Title = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                    CareType = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    DueAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    RepeatRule = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    Status = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AiMessages_AiDialogs_DialogId",
                        column: x => x.DialogId,
                        principalTable: "AiDialogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_AiDialogs_PlantId",
                table: "AiDialogs",
                column: "PlantId");

            migrationBuilder.CreateIndex(
                name: "IX_AiDialogs_UserId",
                table: "AiDialogs",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AiMessages_DialogId",
                table: "AiMessages",
                column: "DialogId");
