...
namespace DeskBoost.Infrastructure.Migrations
{
    ...
    [Migration("20260601093839_ClaimFlowV2")]
    partial class ClaimFlowV2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeskBoost.Domain.Entities.Plant", b =>
                {
                    ...
                    b.Property<Guid?>("MarketplacePlantId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DeskBoost.Domain.Entities.Plant", b =>
                {
                    b.HasOne("DeskBoost.Domain.Entities.MarketplacePlant", "MarketplaceListing")
                        .WithMany()
                        .HasForeignKey("MarketplacePlantId")
                        .OnDelete(DeleteBehavior.SetNull);
