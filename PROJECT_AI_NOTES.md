...
- Next i18n phases: migrate remaining auth pages (`Register`, `ForgotPassword`) and high-traffic app/user pages incrementally; later admin/dashboard; then optional missing-key coverage and backend-safe error display mapping.
