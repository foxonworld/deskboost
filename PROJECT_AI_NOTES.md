...
- Phase 3 backend blockers: missing verified feedback read endpoint, missing admin verified-feedback verification lifecycle, missing ownership fields in current backend responses, and missing QR validate/claim/code lifecycle endpoints.
